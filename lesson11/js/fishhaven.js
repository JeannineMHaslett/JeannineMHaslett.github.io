//json source
const apiURL = `https://api.openweathermap.org/data/2.5/forecast?id=${5585000}&units=imperial&appid=940c61dc043548cf22846b340486879f`;
...
//forecast
const forecastURL = `https://api.openweathermap.org/data/2.5/forecast?id=${5585000}&units=imperial&appid=940c61dc043548cf22846b340486879f`;
fetch(forecastURL)
    .then((response) => response.json())
    .then((jsObject) => {
